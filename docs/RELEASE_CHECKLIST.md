...
- [ ] **SR-F009/SR-F010/SR-F017:** Ledger, Idempotenz, Währung, Preis-Snapshot und Reconciliation fachlich/technisch abgenommen. *(Neue Buchungen frieren Unit Price als `NUMERIC(19,2)` und ISO-Währung ein; Anzeige, Bruttoberechnung, PayPal und Stripe verwenden diese Werte trotz späterer Angebotsänderung. Providergebundene Betrags-/Empfänger-/Application-Fee-Sollwerte und Completed-/Capture-Abgleiche bleiben aktiv; HTTP-, Adapter-, Replay-, Reihenfolge- und Parallelitätsregressionen sind grün. Das Gate bleibt wegen vollständigem Gebührenversions-/Steuer-/Rechnungssnapshot, allgemeinen `Double`-Geldwerten, vollständigen Multi-Währungsregeln, Legacy-Migrationsentscheidung, weiteren Eventabgleichen, abgelaufener Checkout-Erneuerung, Outbox, Ledger, Reconciliation sowie PostgreSQL-/Sandboxnachweis offen.)*
