...
- [ ] **SR-F004:** PayPal-Merchant-Zuordnung ausschließlich serverseitig verifiziert; State/Nonce und Änderungs-Audit grün. *(Direkte Profiländerung, clientvertrauender Return und ungebundener Identity-Fallback am 2026-07-14 entfernt beziehungsweise gesperrt und getestet; Partner-State/Nonce, Audit, Checkout-Abgleich und PayPal-Abnahme bleiben offen.)*
