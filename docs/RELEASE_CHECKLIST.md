...
- [ ] **SR-F009/SR-F010/SR-F017:** Ledger, Idempotenz, Währung, Preis-Snapshot und Reconciliation fachlich/technisch abgenommen. *(Seit 2026-07-15 wird der synchrone PayPal-Capture pessimistisch serialisiert, verlangt `PAYPAL`, exakte Order und `CHECKOUT_CREATED`, akzeptiert nur `COMPLETED` mit Capture-ID und behandelt committed Replays nebenwirkungsfrei. Service-/HTTP-Negativmatrizen sowie ein Zehnfach-Race mit genau einem PSP-Aufruf und einer Mail sind grün. Das Gate bleibt wegen fehlendem Betrag-/Währungs-/Booking-/Payee-Abgleich der Capture-Antwort, Crash-Fenster vor DB-Commit, Stripe-/Webhook-Deduplizierung, Provider-Idempotency-Key, Inbox/Outbox, Ledger, Preis-Snapshot und Reconciliation offen.)*
