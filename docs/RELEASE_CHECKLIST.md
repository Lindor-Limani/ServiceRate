...
- [ ] **SR-F004:** PayPal-Merchant-Zuordnung ausschließlich serverseitig verifiziert; State/Nonce und Änderungs-Audit grün. *(Direkte Profiländerung und clientvertrauender Onboarding-Return am 2026-07-14 entfernt beziehungsweise gesperrt und getestet; servergespeicherter einmaliger State/Nonce, Audit, Checkout-Abgleich und PayPal-Abnahme bleiben offen.)*
