...
- [ ] **SR-F009/SR-F010/SR-F017:** Ledger, Idempotenz, Währung, Preis-Snapshot und Reconciliation fachlich/technisch abgenommen. *(Angebotspreis und neue Buchungs-Unit-Prices sind validierte Dezimalwerte. Checkout berechnet und speichert Brutto, Plattformgebühr und Providerforderung als `NUMERIC(19,2)`, hält die Summeninvariante ein und übergibt PayPal/Stripe die Werte ohne `Double`-Zwischenschritt. Rundungs-/Cap-/Konfigurations-, H2-Persistenz-, Provider-Grenzwert-, Adapter-, Replay- und Parallelitätsregressionen sind grün. Das Gate bleibt wegen Gebührenversions-/Steuer-/Rechnungssnapshot, verbliebenen `Double`-Pfaden, vollständigen Multi-Währungsregeln, versionierter Migration/Legacy-Entscheidung, weiteren Eventabgleichen, abgelaufener Checkout-Erneuerung, Outbox, Ledger, Reconciliation sowie PostgreSQL-/Sandboxnachweis offen.)*
