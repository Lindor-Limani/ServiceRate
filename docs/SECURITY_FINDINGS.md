...
Der synchrone Replay-/Parallelitätsfehler dieses PayPal-Capture-Pfads ist damit geschlossen. SR-F009 bleibt High und Launch-Blocker: Der aktuelle PayPal-Adapter liefert für den Capture-Abgleich weder Betrag, Währung, Booking-ID noch Payee. Das Absturzfenster zwischen erfolgreichem PSP-Effekt und DB-Commit ist ohne Provider-Idempotency-Key, Inbox/Outbox und Recovery offen. Stripe-/Webhook-Deduplizierung, out-of-order Verarbeitung, Ledger/Reconciliation, PostgreSQL-Verifikation und Sandboxnachweis fehlen weiterhin.
