...
Die synchronen Replay-/Parallelitätsfehler des PayPal-Order-/Capture-Pfads einschließlich des Capture-Retry-Fensters und der Capture-Order-/Booking-Zuordnung, der Stripe-Checkout-Erzeugung, der Stripe-Webhook-Event-ID sowie der konkret behandelten Stripe-Completed-/Failed-Reihenfolge sind damit geschlossen. SR-F009 bleibt High und Launch-Blocker: Der aktuelle PayPal-Capture-Abgleich prüft Betrag, Währung und Payee noch nicht. Stripe prüft Betrag, Währung, Payee/Connected Account und Preisgrundlage weiterhin nicht vollständig; weitere Provider-Eventtypen sowie Refund-/Dispute-Lebenszyklen besitzen keine vollständige Reihenfolgepolicy. Ohne unveränderliche Preis-/Währungs-/Payee-Snapshots fehlt für diese Abgleiche weiterhin eine revisionssichere Sollgrundlage. Nichttransaktionaler Mailversand, abgelaufene Checkout-Erneuerung, Outbox/Recovery, Ledger/Reconciliation, versionierte Migration, PostgreSQL-Verifikation und Sandboxnachweis fehlen weiterhin.
