...
Die synchronen Replay-/Parallelitätsfehler des PayPal-Order-/Capture-Pfads einschließlich des Capture-Retry-Fensters an der Providergrenze, der Stripe-Checkout-Erzeugung, der Stripe-Webhook-Event-ID sowie der konkret behandelten Stripe-Completed-/Failed-Reihenfolge sind damit geschlossen. SR-F009 bleibt High und Launch-Blocker: Der aktuelle PayPal-Adapter liefert für den Capture-Abgleich weder Betrag, Währung, Booking-ID noch Payee. Stripe prüft Betrag, Währung, Payee/Connected Account und Preisgrundlage weiterhin nicht vollständig; weitere Provider-Eventtypen sowie Refund-/Dispute-Lebenszyklen besitzen keine vollständige Reihenfolgepolicy. Parameteränderungen vor einem Retry können ohne Preis-Snapshot bei anderen Provideraufrufen weiterhin einen Idempotency-Mismatch verursachen. Nichttransaktionaler Mailversand, abgelaufene Checkout-Erneuerung, Outbox/Recovery, Ledger/Reconciliation, versionierte Migration, PostgreSQL-Verifikation und Sandboxnachweis fehlen weiterhin.
